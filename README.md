...
3. **Проектирование TO-BE (Architectural Design):**
   * **Промпт:** ИИ предложил простой `Circuit Breaker`, жестко блокирующий транзакции ниже себестоимости. Я отбраковал это решение и **самостоятельно продиктовал финальные варианты**: *"Это костыль. Магазин может намеренно продавать товар за $1 в Черную Пятницу. Сделай двухуровневую Shift-Left валидацию на стороне PROMOTION COORDINATOR, а также добавь вариант с проверкой актуальности версий правил"*.
